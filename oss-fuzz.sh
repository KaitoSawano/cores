...
coverpkg="github.com/xcosh/go-xcosh/..."
...
repo=$GOPATH/src/github.com/xcosh/go-xcosh
compile_fuzzer github.com/xcosh/go-xcosh/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer github.com/xcosh/go-xcosh/common/bitutil \
...
compile_fuzzer github.com/xcosh/go-xcosh/eth/protocols/snap \
...
compile_fuzzer github.com/xcosh/go-xcosh/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/xcosh/go-xcosh/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/xcosh/go-xcosh/tests/fuzzers/bls12381 \
...
compile_fuzzer github.com/xcosh/go-xcosh/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
