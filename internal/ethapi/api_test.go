...
import (
	...
	"github.com/xcosh/go-xcosh/internal/blocktest"
...
func newTestBackend(t *testing.T, n int, gspec *genesisT.Genesis, engine consensus.Engine, generator func(i int, b *core.BlockGen)) *testBackend {
	...
	gspec.Alloc[acc.Address] = genesisT.GenesisAccount{Balance: big.NewInt(vars.Ether)}
...
func (b testBackend) SyncProgress() xcosh.SyncProgress { return xcosh.SyncProgress{} }
...
func setupReceiptBackend(t *testing.T, genBlocks int) (*testBackend, []common.Hash) {
	...
	genesis.Config.(*goxcosh.ChainConfig).TerminalTotalDifficulty = big.NewInt(0)
	genesis.Config.(*goxcosh.ChainConfig).TerminalTotalDifficultyPassed = true
