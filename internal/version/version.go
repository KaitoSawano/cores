...
const ourPath = "github.com/xcosh/go-xcosh" // Path to our module
...
// conventions in the Xcosh p2p network.
...
//
// If the package that is currently executing is a prefixed by our go-xcosh
