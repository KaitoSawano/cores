...
// information related to the Xcosh protocol such as blocks, transactions and logs.
...
// Same as xcosh.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria xcosh.FilterQuery
