...
// Defaults contains default settings for use on the Xcosh main net.
var Defaults = Config{
...
type Config struct {
	...
	// If nil, the Xcosh main net block is used.
	...
	// State scheme represents the scheme used to store xcosh states and trie
