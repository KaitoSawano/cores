...
import (
	...
	"github.com/xcosh/go-xcosh/common/bitutil"
	"github.com/xcosh/go-xcosh/core/rawdb"
)

const (
	// bloomServiceThreads is the number of goroutines used globally by an Xcosh
...
func (eth *Xcosh) startBloomHandlers(sectionSize uint64) {
