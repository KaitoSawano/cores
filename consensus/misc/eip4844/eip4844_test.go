...
func TestCalcExcessBlobGas(t *testing.T) {
	var tests = []struct {
		...
		{vars.BlobTxTargetBlobGasPerBlock, (vars.BlobTxTargetBlobGasPerBlock / vars.BlobTxBlobGasPerBlob) - 1, vars.BlobTxTargetBlobGasPerBlock - vars.BlobTxBlobGasPerBlob},
		{vars.BlobTxTargetBlobGasPerBlock, (vars.BlobTxTargetBlobGasPerBlock / vars.BlobTxBlobGasPerBlob) - 2, vars.BlobTxTargetBlobGasPerBlock - (2 * vars.BlobTxBlobGasPerBlob)},
