...
// mapped from textual names used in the tests below to actual Xcosh private
...
// address retrieves the Xcosh address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Xcosh address
	...
	tests := []cliqueTest{
		{
			...
			// batch (https://github.com/xcosh/go-xcosh/issues/17593). Whilst this
