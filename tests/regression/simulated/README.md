...
The blockchains contained in these data files use configurations that are designed to reflect the stages of their namesake production counterparts, eg. Xcosh and Foundation main networks, albeit in smaller "condensed" versions.
...
Note that in the case of foundation-condense* tests, the xcosh/go-xcosh client should be able to successfully import these files as well... likewise any protocol provider programs that supports the configuration and the file encoding.
