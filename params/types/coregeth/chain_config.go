...
type CoreGethChainConfig struct {
	...
	// They show a difference between the upstream configuration data type (goxcosh.ChainConfig) and this one.
	...
	// https://github.com/xcosh/EIPs/blob/master/EIPS/eip-2.md
	EIP2FBlock *big.Int `json:"eip2FBlock,omitempty"`
	// DELEGATECALL
	// https://eips.xcosh.org/EIPS/eip-7
	...
	//
	// EXP cost increase
	// https://github.com/xcosh/EIPs/blob/master/EIPS/eip-160.md
	// NOTE: this json tag:
	...
	// with corresponding refactoring (https://github.com/xcosh/go-xcosh/pull/18401)
	EIP160FBlock *big.Int `json:"eip160Block,omitempty"`
	// State trie clearing (== EIP158 proper)
	// https://github.com/xcosh/EIPs/blob/master/EIPS/eip-161.md
	EIP161FBlock *big.Int `json:"eip161FBlock,omitempty"`
	// Contract code size limit
	// https://github.com/xcosh/EIPs/blob/master/EIPS/eip-170.md
	...
	// https://eips.xcosh.org/EIPS/eip-1706
	EIP1706FBlock *big.Int `json:"eip1706FBlock,omitempty"`

	// https://github.com/xcosh/EIPs/pull/2537: BLS12-381 curve operations
	...
	// https://eips.xcosh.org/EIPS/eip-2315
	...
	// https://eips.xcosh.org/EIPS/eip-2929
	EIP2929FBlock *big.Int `json:"eip2929FBlock,omitempty"`

	// EIP-3198: BASEFEE opcode
	// https://eips.xcosh.org/EIPS/eip-3198
	...
	// Cancun
	EIP4844FTime *uint64 `json:"eip4844FTime,omitempty"` // EIP-4844: Shard Blob Transactions https://eips.xcosh.org/EIPS/eip-4844
	EIP7516FTime *uint64 `json:"eip7516FTime,omitempty"` // EIP-7516: Blob Base Fee Opcode https://eips.xcosh.org/EIPS/eip-7516
	EIP1153FTime *uint64 `json:"eip1153FTime,omitempty"` // EIP-1153: Transient Storage opcodes https://eips.xcosh.org/EIPS/eip-1153
	EIP5656FTime *uint64 `json:"eip5656FTime,omitempty"` // EIP-5656: MCOPY - Memory copying instruction https://eips.xcosh.org/EIPS/eip-5656
	EIP6780FTime *uint64 `json:"eip6780FTime,omitempty"` // EIP-6780: SELFDESTRUCT only in same transaction https://eips.xcosh.org/EIPS/eip-6780
	EIP4788FTime *uint64 `json:"eip4788FTime,omitempty"` // EIP-4788: Beacon block root in the EVM https://eips.xcosh.org/EIPS/eip-4788

	// Cancun with block activations
	EIP4844FBlock *big.Int `json:"eip4844FBlock,omitempty"` // EIP-4844: Shard Blob Transactions https://eips.xcosh.org/EIPS/eip-4844
	EIP7516FBlock *big.Int `json:"eip7516FBlock,omitempty"` // EIP-7516: Blob Base Fee Opcode https://eips.xcosh.org/EIPS/eip-7516
	EIP1153FBlock *big.Int `json:"eip1153FBlock,omitempty"` // EIP-1153: Transient Storage opcodes https://eips.xcosh.org/EIPS/eip-1153
	EIP5656FBlock *big.Int `json:"eip5656FBlock,omitempty"` // EIP-5656: MCOPY - Memory copying instruction https://eips.xcosh.org/EIPS/eip-5656
	EIP6780FBlock *big.Int `json:"eip6780FBlock,omitempty"` // EIP-6780: SELFDESTRUCT only in same transaction https://eips.xcosh.org/EIPS/eip-6780
	EIP4788FBlock *big.Int `json:"eip4788FBlock,omitempty"` // EIP-4788: Beacon block root in the EVM https://eips.xcosh.org/EIPS/eip-4788
