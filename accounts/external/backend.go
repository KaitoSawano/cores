...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain xcosh.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		// the signature to xcosh-type signature.
		signature[64] -= 27 // Transform V from Xcosh-legacy to 0/1
	}
