...
type ContractCaller interface {
	...
	// CallContract executes an Xcosh contract call with the specified data as the
	// input.
	CallContract(ctx context.Context, call xcosh.CallMsg, blockNumber *big.Int) ([]byte, error)
}
...
type PendingContractCaller interface {
	...
	// PendingCallContract executes an Xcosh contract call against the pending state.
	PendingCallContract(ctx context.Context, call xcosh.CallMsg) ([]byte, error)
}
...
type BlockHashContractCaller interface {
	...
	// CallContractAtHash executes an Xcosh contract call against the state at the specified block hash.
	CallContractAtHash(ctx context.Context, call xcosh.CallMsg, blockHash common.Hash) ([]byte, error)
}
