...
// valid Xcosh transaction.
type TransactOpts struct {
	From   common.Address // Xcosh account to send the transaction from
...
// Xcosh network. It contains a collection of methods that are used by the
// higher level contract bindings to operate.
type BoundContract struct {
	address    common.Address     // Deployment address of the contract on the Xcosh blockchain
	abi        abi.ABI            // Reflect based ABI to access the correct Xcosh methods
...
// DeployContract deploys a contract onto the Xcosh blockchain and binds the
...
func (c *BoundContract) Call(opts *CallOpts, results *[]interface{}, method string, params ...interface{}) error {
	...
	var (
		msg    = xcosh.CallMsg{From: opts.From, To: &c.address, Data: input}
