...
// Package bind generates Xcosh contract Go bindings.
//
// Detailed usage document and tutorial available on the go-xcosh Wiki page:
// https://github.com/xcosh/go-xcosh/wiki/Native-DApps:-Go-bindings-to-Xcosh-contracts
package bind
