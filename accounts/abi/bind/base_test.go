...
func (mt *mockTransactor) EstimateGas(ctx context.Context, call xcosh.CallMsg) (gas uint64, err error) {
	return 0, nil
}
...
func (mc *mockCaller) CallContract(ctx context.Context, call xcosh.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockPendingCaller) PendingCallContract(ctx context.Context, call xcosh.CallMsg) ([]byte, error) {
...
func (mc *mockBlockHashCaller) CallContractAtHash(ctx context.Context, call xcosh.CallMsg, hash common.Hash) ([]byte, error) {
