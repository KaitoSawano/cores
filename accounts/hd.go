...
// the `coin_type` 60' (or 0x8000003C) to Xcosh.
//
// The root path for Xcosh is m/44'/60'/0'/0 according to the specification
// from https://github.com/xcosh/EIPs/issues/84, albeit it's not set in stone
