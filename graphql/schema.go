...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Xcosh address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Xcosh account at a particular block.
    type Account {
    ...
    # Transaction is an Xcosh transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Xcosh account at the current block's state.
    ...
    type Pending {
        ...
        transactions: [Transaction!]
        # Account fetches an Xcosh account for the pending state.
        account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Xcosh block by number or by hash. If neither is
