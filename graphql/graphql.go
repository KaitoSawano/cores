...
// Package graphql provides a GraphQL interface to Xcosh node data.
package graphql
...
// Account represents an Xcosh account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an Xcosh transaction.
...
// Block represents an Xcosh block.
...
type CallData struct {
	From                 *common.Address // The Xcosh address the call is from.
	To                   *common.Address // The Xcosh address the call is to.
