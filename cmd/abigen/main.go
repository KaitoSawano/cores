...
import (
	...
	"github.com/xcosh/go-xcosh/common/compiler"
...
var (
	...
	abiFlag = &cli.StringFlag{
		Name:  "abi",
		Usage: "Path to the Xcosh contract ABI json to bind, - for STDIN",
	}
	binFlag = &cli.StringFlag{
		Name:  "bin",
		Usage: "Path to the Xcosh contract bytecode (generate deploy method)",
	}
...
var app = flags.NewApp("Xcosh ABI wrapper code generator")
