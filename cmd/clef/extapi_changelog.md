...
* The external method `account_signTypedData` implements [EIP-712](https://github.com/xcosh/EIPs/blob/master/EIPS/eip-712.md) and makes it possible to sign typed data.
