...
This setup allows a DApp to connect to a remote Xcosh node and send transactions that are locally signed. This can help in situations when a DApp is connected to an untrusted remote Xcosh node, because a local one is not available, not synchronized with the chain, or is a node that has no built-in (or limited) account management.
...
GLOBAL OPTIONS:
   ...
   --keystore value        Directory for the keystore (default: "$HOME/.xcosh/keystore")
...
The signer will generate a new private key, encrypt it according to [web3 keystore spec](https://github.com/xcosh/wiki/wiki/Web3-Secret-Storage-Definition) and store it in the keystore directory.
...
#### Arguments
  - content type [string]: type of signed data
     ...
     - `application/clique`: [clique](https://github.com/xcosh/EIPs/issues/225) headers
...
#### Sign data
   Signs a chunk of structured data conformant to [EIP-712](https://github.com/xcosh/EIPs/blob/master/EIPS/eip-712.md) and returns the calculated signature.
  ...
  "params": [
    {
      "accounts": [
        {
          "url": "keystore:///home/bazonk/.xcosh/keystore/UTC--2017-11-20T14-44-54.089682944Z--123409812340981234098123409812deadbeef42",
          "address": "0x123409812340981234098123409812deadbeef42"
        },
        {
          "url": "keystore:///home/bazonk/.xcosh/keystore/UTC--2017-11-23T21-59-03.199240693Z--cafebabedeadbeef34098123409812deadbeef42",
...
* A Graphical UI MUST show the blocky-identicon for xcosh addresses.
...
| Clef UI| https://github.com/xcosh/clef-ui | Golang/QT-based| :+1:| :+1:| :x:| :+1:| :+1:| :x: |  :+1: (approve tx only)|
