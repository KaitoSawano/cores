...
// Package miner implements Xcosh block creation and mining.
package miner
...
func minerTestGenesisBlock(period uint64, gasLimit uint64, faucet common.Address) *genesisT.Genesis {
