...
import (
	...
	"github.com/xcosh/go-xcosh/crypto/blake2b"
	"github.com/xcosh/go-xcosh/crypto/bls12381"
	"github.com/xcosh/go-xcosh/crypto/bn256"
...
func (c *bigModExp) RequiredGas(input []byte) uint64 {
	...
	if c.eip2565 {
		...
		// in EIP-2565 (https://eips.xcosh.org/EIPS/eip-2565):
		//
		// def mult_complexity(x):
		//    ceiling(x/8)^2
		//
