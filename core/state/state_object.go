...
// stateObject represents an Xcosh account which is being modified.
//
...
type stateObject struct {
	db       *StateDB
	address  common.Address      // address of xcosh account
	addrHash common.Hash         // hash of xcosh address of the account
