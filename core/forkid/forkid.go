...
// Package forkid implements EIP-2124 (https://eips.xcosh.org/EIPS/eip-2124).
package forkid
...
// timestampThreshold is the Xcosh mainnet genesis timestamp. It is used to
...
// NewID calculates the Xcosh fork ID from the chain config, genesis hash, head and time.
...
// NewIDWithChain calculates the Xcosh fork ID from an existing chain instance.
...
func NewStaticFilter(config ctypes.ChainConfigurator, genesis *types.Block) Filter {
...
func newFilter(config ctypes.ChainConfigurator, genesis *types.Block, headfn func() (uint64, uint64)) Filter {
