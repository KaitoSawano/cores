...
func newCanonical(engine consensus.Engine, n int, full bool, scheme string) (ethdb.Database, *genesisT.Genesis, *BlockChain, error) {
	var (
...
func testReorgLong(t *testing.T, full bool, scheme string) {
	testReorg(t, []int64{0, 0, -9}, []int64{0, 0, 0, -9}, 393280+vars.GenesisDifficulty.Int64(), full, scheme)
}
...
func testReorgShort(t *testing.T, full bool, scheme string) {
	...
	testReorg(t, easy, diff, 12615120+vars.GenesisDifficulty.Int64(), full, scheme)
}
...
//
// https://github.com/xcosh/go-xcosh/pull/15941
...
//
// Details at:
//   - https://github.com/xcosh/go-xcosh/issues/18977
//   - https://github.com/xcosh/go-xcosh/pull/18988
...
func testInsertKnownChainDataWithMerging(t *testing.T, typ string, mergeHeight int) {
	...
	if mergeHeight == 0 {
		genesis.Config.SetEthashTerminalTotalDifficulty(big.NewInt(0))
		mergeBlock = uint64(0)
	}
...
func getLongAndShortChains(scheme string) (*BlockChain, []*types.Block, []*types.Block, *genesisT.Genesis, error) {
	// Generate a canonical chain to act as the main dataset
	engine := ethash.NewFaker()
	genesis := &genesisT.Genesis{
		Config:  params.TestChainConfig,
...
func testEIP1559Transition(t *testing.T, scheme string) {
	...
	expected := new(big.Int).Add(
		...
		vars.EIP1234FBlockReward.ToBig(),
	)
...
func TestCreateThenDeletePreByzantium(t *testing.T) {
	...
	testCreateThenDelete(t, &goxcosh.ChainConfig{
...
func TestEIP3651(t *testing.T) {
	...
	gspec.Config.(*goxcosh.ChainConfig).BerlinBlock = common.Big0
	gspec.Config.(*goxcosh.ChainConfig).LondonBlock = common.Big0
	gspec.Config.(*goxcosh.ChainConfig).TerminalTotalDifficulty = common.Big0
	gspec.Config.(*goxcosh.ChainConfig).TerminalTotalDifficultyPassed = true
	gspec.Config.(*goxcosh.ChainConfig).ShanghaiTime = u64(0)
	signer := types.LatestSigner(gspec.Config)
